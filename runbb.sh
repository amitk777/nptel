...
# python3 backBasics.py -input_size 784 -size 128,64,32,16 -lr 0.01 -epochs 1 -batch_size 1
python3 backBasics.py -input_size 784 -size 32,16 -lr 0.01 -epochs 15 -batch_size 100
